  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-2">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-whatsapp sm:h-14 sm:w-14 text-white shadow-[0_10px_28px_-8px_rgba(37,211,102,.7)] transition hover:scale-110"
      >
